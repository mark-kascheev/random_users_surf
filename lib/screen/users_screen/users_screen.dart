                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _UserListItem(
                              user: user, onIconTap: wm.openUserDetails);
                        });
                  }
                }
...
class _UserListItem extends StatelessWidget {
  ...
  const _UserListItem({Key? key, required this.user, required this.onIconTap})
      : super(key: key);
      ...
      child: Row(
        ...
        children: [
          GestureDetector(
              ...
              child: CircleAvatar(
                  foregroundImage: NetworkImage(user.imageUrl), radius: 25)),
          const SizedBox(width: 16),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            mainAxisSize: MainAxisSize.min,
